...
var UIController = (function(){
    ...
    return {
        ...
        displayData : function(data){
                document.querySelector(DOMStrings.budget).textContent = formatNumber(data.budget, data.budget >= 0 ? 'inc' : 'exp');
            
           
            document.querySelector(DOMStrings.totinc).textContent = formatNumber(data.totalinc, 'inc');
            document.querySelector(DOMStrings.totexp).textContent = formatNumber(data.totalexp, 'exp');
        ...
        displayDate : function(){
            ...
            var aestTime = new Date().toLocaleString("en-US", {timeZone: "Asia/Rangoon"});
